...
import { Users, Plus, Search, Edit2, X, RefreshCcw, Eye, Phone, Mail } from 'lucide-react';
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 16 }}>
        <div style={{ position: 'relative', flex: '0 0 260px' }}>
          ...
          <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Nombre, DNI o email..." style={{ paddingLeft: 30, fontSize: 13 }} />
        </div>
              ...
              <tbody>
                {filtered.map((c) => (
                  <tr key={c.id}>
                    ...
                    <td style={{ fontFamily: 'var(--mono)', fontSize: 12 }}>{c.dni}</td>
                    <td>
                    ...
                    <td style={{ fontFamily: 'var(--mono)', fontSize: 13, color: c.currentBalance < 0 ? 'var(--danger)' : c.currentBalance > 0 ? 'var(--warn)' : 'var(--text3)' }}>
